...
public class pregledKorisnika implements Serializable {
    ...
    public pregledKorisnika() {
        dohvatiListuKorisnika();
        brojLinijaPoStranici = Integer.parseInt(dohvatiVrijednostKonfiguracije("broj.linija.korisnik"));
    }
    ...
    private String dohvatiListuKorisnika(){
        try {
            this.listaKorisnika = KomunikacijaBaza.dohvatiListuSvihKorisnika();
